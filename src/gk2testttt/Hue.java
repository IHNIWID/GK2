...
class ppm {
	...
	/**
	 * Load an image in PGM/PPM raw formats and return this If loaded width,
	 * height and pixels are available in the public variables
	 */
	...
	public static void save(String filename, int width, int height, int pixels[]) throws IOException {
